    ...
    public partial class Kinematics_Software_New : RibbonForm
    {
        ...
        public void GeometryType(int DoubleWishboneFront, int DoubleWishboneRear, int McPhersonFront, int McPhersonRear)
        {
            ...
            if (DoubleWishboneFront == 1)
            {
                ...
                A1xFL.Show(); A1yFL.Show(); A1zFL.Show(); A1xFR.Show(); A1yFR.Show(); A1zFR.Show();
                B1xFL.Show(); B1yFL.Show(); B1zFL.Show(); B1xFR.Show(); B1yFR.Show(); B1zFR.Show();
                I1xFL.Show(); I1yFL.Show(); I1zFL.Show(); I1xFR.Show(); I1yFR.Show(); I1zFR.Show(); 
                H1xFL.Show(); H1yFL.Show(); H1zFL.Show(); H1xFR.Show(); H1yFR.Show(); H1zFR.Show(); 
                G1xFL.Show(); G1yFL.Show(); G1zFL.Show(); G1xFR.Show(); G1yFR.Show(); G1zFR.Show(); 
                F1xFL.Show(); F1yFL.Show(); F1zFL.Show(); F1xFR.Show(); F1yFR.Show(); F1zFR.Show(); 
                O1xFL.Show(); O1yFL.Show(); O1zFL.Show(); O1xFR.Show(); O1yFR.Show(); O1zFR.Show(); 
            ...
            else if (McPhersonFront == 1)
            {
                ...
                A1xFL.Hide(); A1yFL.Hide(); A1zFL.Hide(); A1xFR.Hide(); A1yFR.Hide(); A1zFR.Hide(); 
                B1xFL.Hide(); B1yFL.Hide(); B1zFL.Hide(); B1xFR.Hide(); B1yFR.Hide(); B1zFR.Hide();
                I1xFL.Hide(); I1yFL.Hide(); I1zFL.Hide(); I1xFR.Hide(); I1yFR.Hide(); I1zFR.Hide(); 
                H1xFL.Hide(); H1yFL.Hide(); H1zFL.Hide(); H1xFR.Hide(); H1yFR.Hide(); H1zFR.Hide(); 
                G1xFL.Hide(); G1yFL.Hide(); G1zFL.Hide(); G1xFR.Hide(); G1yFR.Hide(); G1zFR.Hide();
                F1xFL.Hide(); F1yFL.Hide(); F1zFL.Hide(); F1xFR.Hide(); F1yFR.Hide(); F1zFR.Hide();
                O1xFL.Hide(); O1yFL.Hide(); O1zFL.Hide(); O1xFR.Hide(); O1yFR.Hide(); O1zFR.Hide(); 
            ...
            if (DoubleWishboneRear == 1)
            {
                ...
                #region Bringing out the changes in UI and values if the Suspension Type is Double Wishbone with Pushrod
                A1xRL.Show(); A1yRL.Show(); A1zRL.Show(); A1xRR.Show(); A1yRR.Show(); A1zRR.Show();
                B1xRL.Show(); B1yRL.Show(); B1zRL.Show(); B1xRR.Show(); B1yRR.Show(); B1zRR.Show(); 
                I1xRL.Show(); I1yRL.Show(); I1zRL.Show(); I1xRR.Show(); I1yRR.Show(); I1zRR.Show(); 
                H1xRL.Show(); H1yRL.Show(); H1zRL.Show(); H1xRR.Show(); H1yRR.Show(); H1zRR.Show();
                G1xRL.Show(); G1yRL.Show(); G1zRL.Show(); G1xRR.Show(); G1yRR.Show(); G1zRR.Show();
                F1xRL.Show(); F1yRL.Show(); F1zRL.Show(); F1xRR.Show(); F1yRR.Show(); F1zRR.Show();
                O1xRL.Show(); O1yRL.Show(); O1zRL.Show(); O1xRR.Show(); O1yRR.Show(); O1zRR.Show(); 
            ...
            else if (McPhersonRear == 1)
            {
                ...
                #region Bringing out the changes in UI and values if the Suspension type is McPherson Strut
                A1xRL.Hide(); A1yRL.Hide(); A1zRL.Hide(); A1xRR.Hide(); A1yRR.Hide(); A1zRR.Hide();
                B1xRL.Hide(); B1yRL.Hide(); B1zRL.Hide(); B1xRR.Hide(); B1yRR.Hide(); B1zRR.Hide(); 
                I1xRL.Hide(); I1yRL.Hide(); I1zRL.Hide(); I1xRR.Hide(); I1yRR.Hide(); I1zRR.Hide(); 
                H1xRL.Hide(); H1yRL.Hide(); H1zRL.Hide(); H1xRR.Hide(); H1yRR.Hide(); H1zRR.Hide(); 
                G1xRL.Hide(); G1yRL.Hide(); G1zRL.Hide(); G1xRR.Hide(); G1yRR.Hide(); G1zRR.Hide();
                F1xRL.Hide(); F1yRL.Hide(); F1zRL.Hide(); F1xRR.Hide(); F1yRR.Hide(); F1zRR.Hide(); 
                O1xRL.Hide(); O1yRL.Hide(); O1zRL.Hide(); O1xRR.Hide(); O1yRR.Hide(); O1zRR.Hide(); 
                ...
                if (index == c_scfr)
                {
                    ...
                    try
                    {
                        ...
                        else if (SuspensionCoordinatesFront.Assy_List_SCFL[c_scfr].McPhersonIdentifierFront == 1)
                        {
                            ...
                            A1xFR.Hide(); A1yFR.Hide(); A1zFR.Hide(); 
                            B1xFR.Hide(); B1yFR.Hide(); B1zFR.Hide(); 
                            I1xFR.Hide(); I1yFR.Hide(); I1zFR.Hide();
                            H1xFR.Hide(); H1yFR.Hide(); H1zFR.Hide(); 
                            G1xFR.Hide(); G1yFR.Hide(); G1zFR.Hide();
                            F1xFR.Hide(); F1yFR.Hide(); F1zFR.Hide(); 
                            O1xFR.Hide(); O1yFR.Hide(); O1zFR.Hide();
