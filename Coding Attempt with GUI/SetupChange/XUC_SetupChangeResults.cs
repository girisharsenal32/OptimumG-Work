...
namespace Coding_Attempt_with_GUI
{
    public partial class XUC_SetupChangeResults : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public void DisplayIndividualOutputs(SetupChange_ClosedLoopSolver _cls, SetupChange_CornerVariables _cv, XUC_SetupChangeResults _resultsGUI, VGridControl _resultsGrid, ref bool _converged)
        {
            ...
            _resultsGrid.SetCellValue(_resultsGUI.rowKPIAngle, 1, Convert.ToString(Math.Round(_cls.Final_KPI[0].Degrees, 2)) + " | " + Convert.ToString(Math.Round(_cls.Final_KPI[_cls.Final_KPI.Count - 1].Degrees, 2)));
            ...
            {
                _resultsGrid.SetCellValue(_resultsGUI.rowLinkKPIDelta, 1, Convert.ToString(Math.Round(_cls.Final_KPIAdjusterLength[_cls.Final_KPIAdjusterLength.Count - 1], 2))/* + " | " + Convert.ToString(Math.Round(_cls.Final_KPIAdjusterLength[0], 2))*/
                    /*_cls.Final_KPIAdjusterLength[_cls.Final_KPIAdjusterLength.Count - 1]*/);
            }
            else
            {
            ...
            _resultsGrid.SetCellValue(_resultsGUI.rowCasterAngle, 1, Convert.ToString(Math.Round(_cls.Final_Caster[0].Degrees, 2)) + " | " + Convert.ToString(Math.Round(_cls.Final_Caster[_cls.Final_Caster.Count - 1].Degrees, 2))
                /*_cls.Final_Caster[_cls.Final_Caster.Count - 1].Degrees*/);
            ...
            {
                _resultsGrid.SetCellValue(_resultsGUI.rowLinkCasterDelta, 1, Convert.ToString(Math.Round(_cls.Final_CasterAdjusterLength[_cls.Final_CasterAdjusterLength.Count - 1], 2)) /*+ " | " + Convert.ToString(Math.Round(_cls.Final_CasterAdjusterLength[0], 2))*/
                    /*_cls.Final_CasterAdjusterLength[_cls.Final_CasterAdjusterLength.Count - 1]*/);
            }
            else
            {
            ...
            _resultsGrid.SetCellValue(_resultsGUI.rowCamberAngle, 1, Convert.ToString(Math.Round(_cls.Final_Camber[0].Degrees, 2)) + " | " + Convert.ToString(Math.Round(_cls.Final_Camber[_cls.Final_Camber.Count - 1].Degrees, 2))
            ...
            _resultsGrid.SetCellValue(_resultsGUI.rowToeAngle, 1, Convert.ToString(Math.Round(_cls.Final_Toe[0].Degrees, 2)) + " | " + Convert.ToString(Math.Round(_cls.Final_Toe[_cls.Final_Toe.Count - 1].Degrees, 2))
            ...
            _resultsGrid.SetCellValue(_resultsGUI.rowRideHeight, 1, _cls.Final_RideHeight[_cls.Final_RideHeight.Count - 1]);
