...
namespace Coding_Attempt_with_GUI
{
    ...
    public class ShortcutsInstaller : Installer
    {
        ...
        public override void Commit(IDictionary savedState)
        {
            ...
            const string LAUNCH_APP_PARAM = "LAUNCH_APP";

            if (!Context.Parameters.ContainsKey(LAUNCH_APP_PARAM))
                throw new Exception(string.Format("The {0} parameter has not been provided for the {1} class.", LAUNCH_APP_PARAM, this.GetType()));

            bool launchapp = Context.Parameters[LAUNCH_APP_PARAM] != string.Empty;
        ...
        {
            string shortcutFullName = Path.Combine(folder, "Girish Internship Test 1.6" + ".lnk");
        ...
        private void LaunchApp()
        {
            ...
            Process.Start(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location) + "\\Coding Attempt with GUI.exe");
