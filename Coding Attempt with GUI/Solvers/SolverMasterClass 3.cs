...
namespace Coding_Attempt_with_GUI
{
    ...
    public class SolverMasterClass
    {
        ...
        double dRideHeight_FL, dRideHeight_FR, dRideHeight_RL, dRideHeight_RR;
        ...
        public void SetupChange_PrimaryInvoker(SetupChange_CornerVariables _FlCV, SetupChange_CornerVariables _FrCV, SetupChange_CornerVariables _RlCV, SetupChange_CornerVariables _RrCV, Vehicle _Vehicle)
        {
            ...
            ///<summary>Finding the final values of the Setup Parameters by adding the changes in the corresponding parameters which the user has requested</summary>
            SetupChange_AssignNewSetupValues(_Vehicle.oc_RL, _RlCV, ref FinalCamberRL, ref FinalToeRL, ref FinalCasterRL, ref FinalKPIRR);
            ///<summary>Finding the final values of the Setup Parameters by adding the changes in the corresponding parameters which the user has requested</summary>
            ...
            if (_FlCV.RideHeightChanged || _FrCV.RideHeightChanged || _RlCV.RideHeightChanged || _RrCV.RideHeightChanged)
            {
                ...
                dRideHeight_FL = SetupChange_GetRideHeightChange(_FlCV, SetupChange_DB_Master.AdjOptions.PushrodLine, SetupChange_DB_Master.AdjOptions.PushrodVector, _FlCV.rideheightAdjustmentType, _FlCV.rideheightAdjustmentTool);

                SetupChange_PrimaryInitializeMethod(_FrCV, _Vehicle.oc_FR, FinalCamberFR, FinalToeFR, FinalCasterFR, FinalKPIFR);
                dRideHeight_FR = SetupChange_GetRideHeightChange(_FrCV, SetupChange_DB_Master.AdjOptions.PushrodLine, SetupChange_DB_Master.AdjOptions.PushrodVector, _FrCV.rideheightAdjustmentType, _FrCV.rideheightAdjustmentTool);

                SetupChange_PrimaryInitializeMethod(_RlCV, _Vehicle.oc_RL, FinalCamberRL, FinalToeRL, FinalCasterRL, FinalKPIRL);
                dRideHeight_RL = SetupChange_GetRideHeightChange(_RlCV, SetupChange_DB_Master.AdjOptions.PushrodLine, SetupChange_DB_Master.AdjOptions.PushrodVector, _RlCV.rideheightAdjustmentType, _RlCV.rideheightAdjustmentTool);

                SetupChange_PrimaryInitializeMethod(_RrCV, _Vehicle.oc_RR, FinalCamberRR, FinalToeRR, FinalCasterRR, FinalKPIRR);
                dRideHeight_RR = SetupChange_GetRideHeightChange(_RrCV, SetupChange_DB_Master.AdjOptions.PushrodLine, SetupChange_DB_Master.AdjOptions.PushrodVector, _RrCV.rideheightAdjustmentType, _RrCV.rideheightAdjustmentTool);

                SetupChange_RideHeightChange_Helper_SolveForRideHeightChanges(_Vehicle, dRideHeight_FL, dRideHeight_FR, dRideHeight_RL, dRideHeight_RR);
            ...
            SetupChange_InvokeChangeSolvers(_Vehicle.oc_FL[0].sccvOP, _Vehicle.oc_FL, 1, FinalCamberFL, FinalToeFL, FinalCasterFL, FinalKPIFL);
            ///<summary>Assigning All the Final Values to the FRONT LEFT Object of the Closed Loop Solver</summary>
            AssignAllFinalValues(1, _Vehicle.oc_FL[0].sccvOP);


            SetupChange_InvokeChangeSolvers(_Vehicle.oc_FR[0].sccvOP, _Vehicle.oc_FR, 2, FinalCamberFR, FinalToeFR, FinalCasterFR, FinalKPIFR);
            AssignAllFinalValues(2, _Vehicle.oc_FR[0].sccvOP);

            SetupChange_InvokeChangeSolvers(_Vehicle.oc_RL[0].sccvOP, _Vehicle.oc_RL, 3, FinalCamberRL, FinalToeRL, FinalCasterRL, FinalKPIRL);
            AssignAllFinalValues(3, _Vehicle.oc_RL[0].sccvOP);

            SetupChange_InvokeChangeSolvers(_Vehicle.oc_RR[0].sccvOP, _Vehicle.oc_RR, 4, FinalCamberRR, FinalToeRR, FinalCasterRR, FinalKPIRR);
            AssignAllFinalValues(4, _Vehicle.oc_RR[0].sccvOP);
        }
        ...
        private void SetupChange_DecideAxisAndAdjuster_KPI(SetupChange_CornerVariables _requestedChange)
        {
            ...
            {
                axisAndAdjusterSelecter_KPI = _requestedChange.LinkLengthsWhichHaveNotChanged[0];
        ...
        private void SetupChange_DecideAxisAndAdjuster_Caster(SetupChange_CornerVariables _requestedChanges)
        {
            ...
            {
                axisAndAdjusterSelecter_Caster = _requestedChanges.LinkLengthsWhichHaveNotChanged[0];
        ...
        private void SetupChange_InvokeChangeSolvers(SetupChange_CornerVariables _RequestedChanges, List<OutputClass> _Oc, int _Identifier, Angle _FinalCamber, Angle _FinalToe, Angle _FinalCaster, Angle _FinalKPI)
        {
            ...
            if (_RequestedChanges.LinkLengthChanged)
            {
                if (_RequestedChanges.deltaTopFrontArm != 0/*true*/)
                {
                    SetupChange_LinkLengthChange_Helper_ChangeLinkLength(_RequestedChanges.deltaTopFrontArm, _RequestedChanges.deltaTopRearArm, SetupChange_DB_Master.LBJToToeLink.Line.DeltaLine[SetupChange_DB_Master.LBJToToeLink.Line.DeltaLine.Count - 1],
                                                                         ...
                                                                         AdjustmentTools.TopFrontArm, SetupChange_CLS_Master.Final_TopFrontArm, SetupChange_CLS_Master.Final_TopRearArm, _Oc, 0, SetupChange_DB_Master.AdjOptions.TopWishbonePlane);
                ...
                if (_RequestedChanges.deltaTopRearArm != 0/*true*/)
                {
                    ...
                    SetupChange_LinkLengthChange_Helper_ChangeLinkLength(_RequestedChanges.deltaTopRearArm, _RequestedChanges.deltaTopFrontArm, SetupChange_DB_Master.LBJToToeLink.Line.DeltaLine[SetupChange_DB_Master.LBJToToeLink.Line.DeltaLine.Count - 1],
                                                                         ...
                                                                         AdjustmentTools.TopRearArm, SetupChange_CLS_Master.Final_TopRearArm, SetupChange_CLS_Master.Final_TopFrontArm, _Oc, 0, SetupChange_DB_Master.AdjOptions.TopWishbonePlane);
                ...
                if (_RequestedChanges.deltaBottmFrontArm != 0 /*true*/)
                {
                    ...
                    SetupChange_LinkLengthChange_Helper_ChangeLinkLength(_RequestedChanges.deltaBottmFrontArm, _RequestedChanges.deltaBottomRearArm, SetupChange_DB_Master.UBJToToeLink.Line.DeltaLine[SetupChange_DB_Master.UBJToToeLink.Line.DeltaLine.Count - 1],
                                                                         ...
                                                                         AdjustmentTools.BottomFrontArm, SetupChange_CLS_Master.Final_BottomFrontArm, SetupChange_CLS_Master.Final_BottomRearArm, _Oc, 1, SetupChange_DB_Master.AdjOptions.BottomWishbonePlane);
                ...
                if (_RequestedChanges.deltaBottomRearArm != 0 /*true*/)
                {
                    ...
                    SetupChange_LinkLengthChange_Helper_ChangeLinkLength(_RequestedChanges.deltaBottomRearArm, _RequestedChanges.deltaBottmFrontArm, SetupChange_DB_Master.UBJToToeLink.Line.DeltaLine[SetupChange_DB_Master.UBJToToeLink.Line.DeltaLine.Count - 1],
                                                                         ...
                                                                         AdjustmentTools.BottomRearArm, SetupChange_CLS_Master.Final_BottomRearArm, SetupChange_CLS_Master.Final_BottomFrontArm, _Oc, 1, SetupChange_DB_Master.AdjOptions.BottomWishbonePlane);
                ...
                if (_RequestedChanges.deltaPushrod != 0)
                {
                    ...
                    //SetupChange_LinkLengthChange_Helper_ChangeLinkLength(_RequestedChanges.deltaPushrod, SetupChange_DB_Master.AdjOptions.PushrodLine, SetupChange_DB_Master.AdjOptions.PushrodVector, AdjustmentTools.PushrodLength, SetupChange_CLS.Final_Pushrod, _Oc);
                }
        ...
        private double SetupChange_GetRideHeightChange(SetupChange_CornerVariables _reqChanges, List<Line> _line, List<Vector3D> _vector, AdjustmentType _adjType, AdjustmentTools _adjTools)
        {
            ...
            else
            {
                if (_adjTools == AdjustmentTools.PushrodLength)
                {
                    ...
                    _dRideHeight = Math.Sin(_line[_line.Count - 1].Length() - _line[0].Length()); 
                }
            }
            return _dRideHeight;
        }
        ...
        private void SetupChange_LinkLengthChange_Helper_ChangeLinkLength(double _deltaLinkLength, double _deltaCounterLinklength, Line _axisRot, List<Line> _linkLine, List<Vector3D> _linkVector, List<Line> _colinkLine, List<Vector3D> _colinkVector, AdjustmentTools _adjTool,
                                                                          List<double> _finalLinkLengthList, List<double> _fincoDList, List<OutputClass> _ocLink, int _upVertex, Plane _plane)
        {
            ...
            SetupChange_LinkLengthChange(AngleToBeRotated.Degrees, _deltaLinkLength, _deltaCounterLinklength, _ocLink[0], _axisRot, _linkLine, _linkVector, _colinkLine, _colinkVector, _finalLinkLengthList, _fincoDList, _upVertex, _plane,_adjTool);
        ...
        internal void SetupChange_LinkLengthChange(double _angleRot, double _dLength, double _counterDLength, OutputClass _oc, Line _axisRot, List<Line> _linkLine, List<Vector3D> _linkVector, List<Line> _coLinkLine, List<Vector3D> _coLinkVector, List<double> _finDLength,
                                                   List<double> _finCoDLength, int _upVert, Plane _planeArms, AdjustmentTools _adjTool)
        {
            ...
            RotateWheelAssemblyComponents(_axisRot, angleOfRotation, _oc);
            RotateSteeringAxis(_axisRot, angleOfRotation);
            RotateUprightTriangle(_axisRot, angleOfRotation, AdjustmentType.Indirect);
        ...
        internal void SetupChange_CamberChange(double _dCamber, OutputClass _ocSetupCamber, bool _undoRotatation, SetupChange_CornerVariables _sccv, List<Line> _shimsLine, List<Vector3D> _shimsVector, Line _axisOfRotation, int _upIndex)
        {
            ...
            RotateWheelAssemblyComponents(_axisOfRotation, dCamber, _ocSetupCamber);
            RotateUprightTriangle(_axisOfRotation, dCamber,_sccv.camberAdjustmentType);
        ...
        internal void SetupChange_ToeChange(double _dToe, OutputClass _ocSetupToe, bool _undoChange, SetupChange_CornerVariables _sccv, List<Line> _shimsLine, List<Vector3D> _shimsVector, Line _axisOfRotation, int _upIndex)
        {
            ...
            ///<summary>Rotating the Wheel Assembyly Points and Vectors using the <see cref="RotateWheelAssemblyComponents(Vector3D, Angle, OutputClass)"/> </summary>
            RotateWheelAssemblyComponents(_axisOfRotation, dToe, _ocSetupToe);
            RotateUprightTriangle(_axisOfRotation, dToe, _sccv.toeAdjustmentType);
            ...
            SetupChange_CLS_Master.Final_ToeAdjusterLength.Add(SetupChange_CLS_Master.Summ_dToeAdjusterLength[SetupChange_CLS_Master.Summ_dToeAdjusterLength.Count - 1]);
        ...
        internal void SetupChange_CasterChange(double _dCaster, OutputClass _ocSetupCaster, bool _undoChange, SetupChange_CornerVariables _sccv, List<Line> _linkLine, List<Vector3D> _linkVector, Line _axisOfRotation, int _uprightVertex)
        {
            ...
            ///</summary>
            RotateSteeringAxis(/*(SetupChange_DB_Master.LBJToToeLink.Line.DeltaLine[SetupChange_DB_Master.LBJToToeLink.Line.DeltaLine.Count - 1])*/ _axisOfRotation, dCaster);
            RotateWheelAssemblyComponents(/*(SetupChange_DB_Master.LBJToToeLink.Line.DeltaLine[SetupChange_DB_Master.LBJToToeLink.Line.DeltaLine.Count - 1])*/ _axisOfRotation, dCaster, _ocSetupCaster);
            RotateUprightTriangle(_axisOfRotation, dCaster, _sccv.casterAdjustmentType);
        ...
        internal void SetupChange_KPIChange(double _dKPI, OutputClass _ocSetupKPI, bool _undoChange, SetupChange_CornerVariables _sccv, List<Line> _linkLengthLine, List<Vector3D> _linkLengthVector, Line _axisRotation, int _uprightVertex)
        {
            ...
            ///<see cref="RotateSteeringAxis(Vector3D, Angle)"/>
            ///</summary>
            RotateSteeringAxis(_axisRotation, dKPI);
            RotateWheelAssemblyComponents(_axisRotation, dKPI, _ocSetupKPI);
            RotateUprightTriangle(_axisRotation, dKPI, _sccv.kpiAdjustmentType);
        ...
        private void RotateWheelAssemblyComponents(Line _rotationLine, Angle _rotationAngle, OutputClass _ocRotate )
        {
        ...
        /// <param name="_rotationAngle"></param>
        /// <param name="i"></param>
        private void RotateSteeringAxis(Line _rotationLine, Angle _rotationAngle)
        {
        ...
        /// <param name="_rotationLine"></param>
        /// <param name="_rotationAngle"></param>
        private void RotateUprightTriangle(Line _rotationLine, Angle _rotationAngle, AdjustmentType _adjType)
        {
            if (_adjType == AdjustmentType.Direct) 
            {
        ...
        private void AssignAllFinalValues(int Identifier, SetupChange_CornerVariables _sccvOut)
        {
            ...
            if (_sccvOut.rideheightAdjustmentTool == AdjustmentTools.PushrodLength)
            {
                SetupChange_CLS_Master.Final_Pushrod.Add(SetupChange_DB_Master.AdjOptions.MRideHeightAdjusterLine[SetupChange_DB_Master.AdjOptions.MRideHeightAdjusterLine.Count - 1].Length());
            }
